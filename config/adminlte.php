...
return [
   ...
   'preloader' => [
      'enabled' => true,
      'img' => [
         'path' => 'images/logo_banner.png',
         'alt' => 'Certificados UTS',
   ...
   'classes_auth_card' => 'bg-gardien-dark',
   'classes_auth_header' => '',
   'classes_auth_body' => 'bg-success color-palette',
   ...
   'menu' => [
      ...
      [
         ...
         'url'         => 'solicitudes/admin/index/pendiente',
