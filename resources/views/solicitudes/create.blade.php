            ...
            <div class="callout callout-success">
               ...
               <div class="row">
                  <div class="col-2">
                     <x-adminlte-select name="tipo_documento" label="Tipo de documento *" label-class="text-lightblue">
                        <x-adminlte-options :options="app('tipo_documento')" empty-option="Seleccione" placeholder="Seleccione"
                           required />
                     </x-adminlte-select>
                  </div>
                  <div class="col-2">
               ...
               <div class="row">
                  <div class="col-4">
                     ...
                     <p class="text-lightblue"><b>Recuerde:</b> El correo electrónico que está ingresando en este campo, es
                        con el que tendremos contacto con usted y al cual enviaremos el certificado una vez generado.</p>
                  </div>
                  <div class="col-8">
