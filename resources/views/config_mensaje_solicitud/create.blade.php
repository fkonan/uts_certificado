...
@section('content')
   <div class="card">
      ...
      <div class="card-body">
         <form action="{{ route('config-mensaje-solicitud.store') }}" method="POST" class="needs-validation" novalidate>
            @csrf
            <div class="row">
               <div class="col-md-12">
            ...
            <div class="row">
               ...
               <div class="col-9">
                  <x-adminlte-input type="text" name="asunto" id="asunto" label="Asunto del correo" required
                     placeholder="Ej: Generacion de certificado..." label-class="text-lightblue" enable-old-support>
                     <x-slot name="prependSlot">
                        <div class="input-group-text">
            ...
            <div class="row">
               <div class="col-12">
                  <label for="descripcion" class="text-lightblue">Decripción del correo</label>
